...
$pdf->Image('../logo/Screenshot 2024-01-23 110029.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'MARKET MAKMUR',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 081397523562',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Jl. Siumbut - Umbut, Kisaran ',0,'L');
$pdf->SetX(4);
